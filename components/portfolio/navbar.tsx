      ...
      <div className="mx-auto flex w-[min(72rem,calc(100%-1.6rem))] items-center justify-between gap-4 py-2.5 md:w-[min(72rem,calc(100%-4rem))]">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="hidden items-center gap-1.5 rounded-full border border-border px-3.5 py-2 text-xs font-semibold transition-all hover:-translate-y-0.5 hover:border-primary hover:text-primary sm:inline-flex"
          >
